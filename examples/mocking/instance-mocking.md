...
Also sTest supports running asynchronous tests. Here is an example of runnig async tests:
...
And here is an example of instance mocking with async implementations:
